...
// PNGs are already compressed, so store adds negligible size and avoids native/ESM deps.
...
// Fixed 1980-01-01 timestamp keeps output deterministic (Date.now is unavailable in some contexts).
const DOS_TIME = 0;
const DOS_DATE = 0x21;
